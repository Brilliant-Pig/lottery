    ...
    export default {
        ...
        data() {
            return {
                ...
                asideWidth: 195,
                headerHeight: 80,
                circleUrl: localStorage.getItem('avatarUrl') || DEFAULT_AVATAR,
                sharedAvatar: reactive({
                    url: localStorage.getItem('avatarUrl') || DEFAULT_AVATAR,
                    update: this.updateAvatar
                }),
                customItems: [
                    { 
                        text: '使用说明', 
        ...
        provide() {
            return {
                sharedAvatar: this.sharedAvatar
            }
        },
        created() {
        ...
        emitter.on('avatar-updated', this.handleAvatarUpdate);
            this.$watch('sharedAvatar.url', (newVal) => {
                this.circleUrl = newVal;
            });
    },
    beforeUnmount() {
