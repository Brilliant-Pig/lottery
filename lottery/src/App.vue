    <template>
        ...
        <div class="demo-container">
            ...
            <!-- TinyVue布局容器 -->
            <tiny-container :pattern="pattern" :aside-width="asideWidth" :header-height="headerHeight">
                ...
                <template #aside>
                    <div :class="['aside-container', { 'is-collapsed': isCollapsed }]" @mouseenter="handleAsideEnter"
                        @mouseleave="handleAsideLeave">
                        <!-- 侧边栏插槽 -->
                        <div class="collapse-button" @mouseenter="handleArrowHover" @mouseleave="handleArrowLeave"
                            :style="{ right: isCollapsed ? 'calc(100% - 12px)' : '-12px' }">
                        ...
                        <el-scrollbar>
                            <div v-for="(item, index) in customItems" :key="index" class="scrollbar-demo-item"
                                ...
                                <!-- 父级按钮 -->
                                <el-button :type="item.type" plain :class="{ 'button-hover': hoverIndex === index }"
                                    :data-type="item.type"
                                ...
                                <transition name="submenu">
                                    <div v-if="item.children && hoverIndex === index" class="submenu-container">
                                        <!-- 子菜单选项 -->
                                        <div v-for="(child, childIndex) in item.children" :key="childIndex"
                                            class="submenu-item" @mouseenter="childHover = childIndex"
                                            @mouseleave="childHover = -1">
                                            <!-- 子菜单按钮 -->
                                            <el-button :type="child.type" plain
...
.el-button--success:hover {
    background: linear-gradient(45deg,
            ...
            var(--el-color-success-light-9)) !important;
}
...
.el-button--danger:hover {
    background: linear-gradient(45deg,
            ...
            var(--el-color-danger-light-9)) !important;
}

.el-button--info:hover {
    background: linear-gradient(45deg,
            var(--el-color-info-light-3),
            var(--el-color-info-light-9)) !important;
}
...
.el-button--warning:hover {
    background: linear-gradient(45deg,
            ...
            var(--el-color-warning-light-9)) !important;
}
